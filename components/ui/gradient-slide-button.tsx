...
export function GradientSlideButton({
     ...
     return (
          <button
               ...
               className={cn(
                    "relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-md bg-neutral-50 px-4 py-2 text-sm font-medium whitespace-nowrap text-black transition-all duration-300 hover:scale-[105%] dark:bg-neutral-800 dark:text-white",
